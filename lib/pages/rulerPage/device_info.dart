...
enum DeviceClassType { Phone, Tablet, Tv, Stb }

class DeviceExtInfo {
  static const MethodChannel _channel = MethodChannel('device_ext_info');
  ...
  static Future<DeviceClassType> get deviceClass async {
    final String deviceClassString =
        await _channel.invokeMethod('getDeviceClass');
    return DeviceClassType.values.firstWhere((e) =>
        e.toString().split('.')[1].toUpperCase() ==
        deviceClassString.toUpperCase());
  }
}
